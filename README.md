...
|:---:|:---:|:---:|:---:|:---:|
| **row 1** | 1 | 0 | 0 | 0 |
| **row 2** | 0 | cos θ | −sin θ | 0 |
| **row 3** | 0 | sin θ | cos θ | 0 |
| **row 4** | 0 | 0 | 0 | 1 |

Multiplied by `(x, y, z, 1)` gives:
...
| | col 1 | col 2 | col 3 | col 4 |
|:---:|:---:|:---:|:---:|:---:|
| **row 1** | cos θ | 0 | sin θ | 0 |
| **row 2** | 0 | 1 | 0 | 0 |
| **row 3** | −sin θ | 0 | cos θ | 0 |
| **row 4** | 0 | 0 | 0 | 1 |
...
| | col 1 | col 2 | col 3 | col 4 |
|:---:|:---:|:---:|:---:|:---:|
| **row 1** | cos θ | −sin θ | 0 | 0 |
| **row 2** | sin θ | cos θ | 0 | 0 |
| **row 3** | 0 | 0 | 1 | 0 |
| **row 4** | 0 | 0 | 0 | 1 |
